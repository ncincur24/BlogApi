    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HashTagBlogs", x => new { x.BlogId, x.HashTagId });
                    table.ForeignKey(
                        name: "FK_HashTagBlogs_Blogs_BlogId",
                        column: x => x.BlogId,
                        principalTable: "Blogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HashTagBlogs_HashTags_HashTagId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HashTagBlogs_HashTagId",
                table: "HashTagBlogs",
                column: "HashTagId");
